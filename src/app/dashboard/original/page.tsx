...
export default async function OriginalDashboardPage() {
        ...
        <CardContent>
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2">
            <div className="space-y-1">
              <p className="text-xs sm:text-sm font-medium text-black/70 mb-1">
                Brand Name
              </p>
        ...
        <CardContent>
          {recentMentions.length === 0 ? (
            <div className="text-center py-8 text-black">
              ...
              <p className="text-xs">
                Run queries to start tracking your brand
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              {recentMentions.map(({ mention, query }) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`h-10 w-10 rounded-full ${getSentimentColor(mention.sentiment || 'neutral')} flex items-center justify-center`}
                    >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-2 text-xs text-black">
                        ...
                        <span>•</span>
                        <span
                          className={getSentimentTextColor(
