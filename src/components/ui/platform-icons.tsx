...
export function PlatformIcon({ platform, size = 20, className }: PlatformIconProps) {
  ...
  switch (platform.toLowerCase()) {
    ...
    case 'chatgpt':
      return (
        <div 
          className={cn('flex items-center justify-center rounded-md bg-green-100 text-green-700 border border-green-200', className)}
          style={style}
        >
    ...
    case 'claude':
      return (
        <div 
          className={cn('flex items-center justify-center rounded-md bg-orange-100 text-orange-700 border border-orange-200', className)}
          style={style}
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3">
    ...
    case 'bard':
      return (
        <div 
          className={cn('flex items-center justify-center rounded-md bg-blue-100 text-blue-700 border border-blue-200', className)}
          style={style}
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3">
    ...
    default:
      return (
        <div 
          className={cn('flex items-center justify-center rounded-md bg-gray-100 text-gray-700', className)}
          style={style}
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
