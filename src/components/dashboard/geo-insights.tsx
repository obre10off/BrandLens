...
interface InsightData {
  ...
  category: 'visibility' | 'sentiment' | 'competitive' | 'content' | 'technical';
  actionable: boolean;
  cta?: {
    label: string;
    href: string;
      ...
      <CardContent>
        {insights.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-black/70 mb-4">Insights will appear as we analyze your brand data</p>
            <Button>
              Run Analysis
            </Button>
          </div>
          ...
          <div className="space-y-4">
              ...
              >
                  ...
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge size="sm" className={cn('px-2 py-1', getPriorityColor(insight.priority))}>
                          {insight.priority}
                        </Badge>
                      </div>
                ...
                {insight.metrics && (
                  <div className="mb-3 p-3 rounded-md bg-white/50">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-black/70">Current: {insight.metrics.current}{insight.metrics.unit}</span>
                      <ArrowRight className="h-3 w-3 text-gray-400" />
                      <span className="font-medium text-black">Target: {insight.metrics.target}{insight.metrics.unit}</span>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    ...
                    <span className={cn('font-medium', getEffortColor(insight.effort))}>
                      {insight.effort}
                    </span>
                  </div>
                </div>
                ...
                {insight.actionable && insight.cta && (
                  <div className="flex justify-end">
                    <Link href={insight.cta.href}>
                      <Button size="sm" variant={insight.priority === 'high' ? 'default' : 'outline'}>
                        {insight.cta.label}
            ...
            <div className="mt-6 p-4 rounded-lg bg-blue-50 border border-blue-100">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm text-blue-800">
                <div>
                  <div className="font-medium">{actionableCount} Actions Available</div>
                  <div className="text-blue-700">Ready to implement now</div>
                </div>
                <div>
                  <div className="font-medium">{highPriorityCount} High Priority Items</div>
