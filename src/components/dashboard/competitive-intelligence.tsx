...
export function CompetitiveIntelligence({
  ...
  const allBrands = [yourBrand, ...competitors].sort(
    ...
    <Card className={cn('competitive-intelligence-card', className)}>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="text-black/70">
              AI share of voice across {totalMentions.toLocaleString()} total
              mentions
            </CardDescription>
          </div>
      ...
      <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="text-center">
                  ...
                  >
                    ...
                    {yourBrand.trendValue > 0 ? '+' : ''}
                    {yourBrand.trendValue}%
                  </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className={cn(
                        'font-medium',
                        brand.isYou ? 'text-primary' : 'text-black'
                      )}
                    >
                      {brand.name}
                    </span>
                  ...
                  <div className="flex items-center gap-4 text-xs text-black/70">
                    ...
                    <Badge
                      ...
                      className={cn(
                        'px-2 py-0.5',
                        getSentimentColor(brand.sentiment.average)
                      )}
                    >
                ...
                <div className="flex items-center gap-2 w-24">
                  ...
                  <span
                    className={cn(
                      'text-xs font-medium',
                      getTrendColor(brand.trend, brand.trendValue)
                    )}
                  >
                    {brand.trendValue > 0 ? '+' : ''}
                    {brand.trendValue}%
        ...
        <div className="space-y-4">
          {/* Biggest Threat */}
          {marketInsights.biggestThreat &&
            marketInsights.biggestThreat !== yourBrand.name && (
              <div className="p-4 rounded-lg bg-red-50 border border-red-100">
                ...
                <p className="text-sm text-red-800">
                  <strong>{marketInsights.biggestThreat}</strong> is gaining
                  market share and could impact your position
                </p>
              </div>
            )}
