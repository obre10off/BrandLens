...
export function QueryPerformance({
  ...
  const avgPerformanceScore =
    queries.length > 0
      ? Math.round(
          queries.reduce((sum, q) => sum + q.performanceScore, 0) /
            queries.length
        )
      : 0;
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              ...
              <div>
                <div className="font-medium text-black">
                  {topPerformer.mentionCount}
                </div>
                <div className="text-xs text-black/70">Mentions</div>
              </div>
              <div>
                <div className="font-medium text-black">
                  {topPerformer.avgSentiment}%
                </div>
          ...
          {queries.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-black/70 mb-4">
                Create your first query to start monitoring
              </p>
              <Link href="/dashboard/queries">
                <Button>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h5 className="font-medium text-black truncate">
                        {query.name}
                      </h5>
                      <Badge
                        size="sm"
                  ...
                  <div className="text-center w-16">
                    <div
                      className={cn(
                        'text-lg font-bold',
                        getScoreColor(query.performanceScore)
                      )}
                    >
                    ...
                    <div
                      className={cn(
                        ...
                        getScoreBackground(query.performanceScore)
                      )}
                    >
                      <div
