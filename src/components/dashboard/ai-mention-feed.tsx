        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="text-black/70">
              Recent brand mentions from {totalMentions.toLocaleString()} AI
              conversations
            </CardDescription>
          </div>
        ...
        {mentions.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-black/70 mb-4">
              Run your first query to start tracking AI mentions
            </p>
                ...
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <Badge
                      ...
                      className={cn(
                        'px-2 py-1',
                        getPlatformColor(mention.platform)
                      )}
                    >
                      {mention.llmModel}
                    </Badge>
                    <Badge
                      ...
                      className={cn(
                        'px-2 py-1',
                        getMentionTypeColor(mention.mentionType)
                      )}
                    >
                      {mention.mentionType}
                    </Badge>
                ...
                <div className="space-y-2">
                  ...
                  {mention.context && (
                    <div className="text-black/80">
                      <h5 className="text-xs font-medium text-black/70 mb-1">
                        Context:
                      </h5>
